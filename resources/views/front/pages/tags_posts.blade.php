                        ...
                        <article class="card article-card article-card-sm h-100">
                            ...
                            <div class="card-body px-0 pb-0">
                                <!--<ul class="post-meta mb-2">
                                        <li>
                                            <a
                                                href=" /*route('category_posts', $category->slug)*/ }}">/* $category->subcategory_name*/ }}</a>
                                        </li>
                                    </ul>-->
                                ...
                                <div class="content"> <a class="read-more-btn"
                                        href="{{ route('read_posts', $item->post_slug) }}">Read Full Article</a>
                                </div>
                            </div>
                        </article>
                    </div>
                                ...
                                <div class="widget-list">
                                    @if (latest_first_sidebar_post())
                                        <article class="card mb-4">
                                            <div class="card-image">
                                                <div class="post-info"> <span
                                                        class="text-uppercase">{{ date_formatter(latest_first_sidebar_post()->created_at) }}</span>
                                                </div>
                                                <img loading="lazy" decoding="async"
                                            ...
                                            <div class="card-body px-0 pb-1">
                                                <h3><a class="post-title post-title-sm"
                                                        href="{{ route('read_posts', latest_first_sidebar_post()->post_slug) }}">
                                        ...
                                        @foreach (categories() as $item)
                                            <li>
                                                <a href="{{ route('category_posts', $item->slug) }}">
                                                    {{ Str::ucfirst($item->subcategory_name) }}
