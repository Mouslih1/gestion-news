...
<form action="{{ route('author.posts.update-post', ['post_id' => Request('post_id') ]) }}" id='editPostForm' method="post" enctype="multipart/form-data">
    @csrf
    <div class="card mt-2">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="post_tags" value="{{ $post->post_tags }}" class="form-control">
                      </div>
